...
if (horaAtual.getHours() < 12) {
    ...
    document.getElementById("imagemhora").src = "style/img/manha.jpg";
    ...
    document.getElementById("imagemhora").src = "style/img/tarde.jpg"; 
} else {
    ...
    document.getElementById("rodape-text").style.color = "white";
    document.getElementById("imagemhora").src = "style/img/noite.jpg"; 
}
